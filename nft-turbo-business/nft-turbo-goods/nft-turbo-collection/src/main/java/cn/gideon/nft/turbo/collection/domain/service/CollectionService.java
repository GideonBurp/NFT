package cn.gideon.nft.turbo.collection.domain.service;
...
public interface CollectionService extends IService<Collection> {
     ...
     * 新的实现方式见 {@link cn.gideon.nft.turbo.collection.domain.service.impl.HeldCollectionService#create(HeldCollectionCreateRequest)}
     */
    @Deprecated
