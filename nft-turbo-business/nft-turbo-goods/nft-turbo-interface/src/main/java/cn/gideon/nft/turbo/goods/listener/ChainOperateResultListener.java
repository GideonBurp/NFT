package cn.gideon.nft.turbo.goods.listener;

import cn.gideon.nft.turbo.api.box.constant.BlindBoxStateEnum;
import cn.gideon.nft.turbo.api.chain.model.ChainOperateBody;
import cn.gideon.nft.turbo.api.chain.response.data.ChainResultData;
import cn.gideon.nft.turbo.api.collection.constant.CollectionStateEnum;
import cn.gideon.nft.turbo.api.collection.constant.HeldCollectionState;
...
import cn.gideon.nft.turbo.box.domain.service.BlindBoxService;
import cn.gideon.nft.turbo.box.exception.BlindBoxException;
...
import cn.gideon.nft.turbo.collection.domain.request.HeldCollectionActiveRequest;
...
import cn.gideon.nft.turbo.collection.exception.CollectionException;
import cn.gideon.turbo.stream.consumer.AbstractStreamConsumer;
import cn.gideon.turbo.stream.param.MessageBody;
...
import static cn.gideon.nft.turbo.box.exception.BlindBoxErrorCode.BLIND_BOX_INVENTORY_UPDATE_FAILED;
import static cn.gideon.nft.turbo.collection.exception.CollectionErrorCode.COLLECTION_QUERY_FAIL;
import static cn.gideon.nft.turbo.collection.exception.CollectionErrorCode.HELD_COLLECTION_QUERY_FAIL;
