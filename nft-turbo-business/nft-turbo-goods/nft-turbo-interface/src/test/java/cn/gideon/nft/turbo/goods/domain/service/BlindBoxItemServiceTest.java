package cn.gideon.nft.turbo.goods.domain.service;

import cn.gideon.nft.turbo.api.box.constant.BlindAllotBoxRule;
import cn.gideon.nft.turbo.api.box.constant.BlindBoxItemStateEnum;
...
import cn.gideon.nft.turbo.api.collection.response.BlindBoxCollectionSaleResponse;
import cn.gideon.nft.turbo.api.goods.request.GoodsConfirmSaleRequest;
import cn.gideon.nft.turbo.api.goods.request.GoodsTrySaleRequest;
...
import cn.gideon.nft.turbo.box.domain.service.BlindBoxItemService;
...
import cn.gideon.nft.turbo.goods.GoodsBaseTest;
