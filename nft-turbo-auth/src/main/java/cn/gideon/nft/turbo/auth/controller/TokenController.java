...
import cn.gideon.nft.turbo.auth.constant.TokenSceneEnum;
import cn.gideon.nft.turbo.auth.exception.AuthErrorCode;
import cn.gideon.nft.turbo.auth.exception.AuthException;
import cn.gideon.nft.turbo.web.util.TokenUtil;
...
import static cn.gideon.nft.turbo.cache.constant.CacheConstant.CACHE_KEY_SEPARATOR;
import static cn.gideon.nft.turbo.web.util.TokenUtil.TOKEN_PREFIX;
